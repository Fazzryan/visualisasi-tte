...
@if (session('success'))
    <div x-data="{ show: true }" x-show="show" x-transition
        ...
        {{-- TOMBOL CLOSE YANG SUDAH DIAKTIFKAN --}}
...
@if (session('warning'))
    <div x-data="{ show: true }" x-show="show" x-transition
        ...
        <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
            viewBox="0 0 20 20">
            <path
                d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM8.5 6a1.5 1.5 0 1 1 3 0v5a1.5 1.5 0 1 1-3 0V6ZM10 15.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z" />
        </svg>
...
@if (session('failed') || session('error'))
    {{-- Tambahkan session('error') juga, karena Anda menggunakannya di middleware --}}
    <div x-data="{ show: true }" x-show="show" x-transition
